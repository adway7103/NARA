    ...
    return(
        <>
           <div className="relative cursor-pointer " onClick={toggleCartOpen}>
            <div className="absolute z-50 bg-black dark:!bg-[#fff] text-[#fff] dark:text-black text-[70%] p-0 rounded-full flex items-center justify-center top-0 right-0 w-4 h-4 "><span>{totalQuantity<=9 ? totalQuantity: "9+"}</span></div>
            <img
